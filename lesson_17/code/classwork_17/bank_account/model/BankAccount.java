...
public class BankAccount {
    ...
    public BankAccount(long id, String owner, String bankName, int branch, double balance) {
      ...
      // sozdajom vtoroj construktor
     // METOD POLIMOEFIZM I VYDELIAEM BEZ BALANCE
    // NAZVANIJA BanAccount ne meniaetsia
    // otliciaetsia po metadam orgumenta
    // MENSE MOZET BYT; BOLSE NET
