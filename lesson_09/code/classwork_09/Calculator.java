...
public class Calculator {
    ...
    static int num1, num2, action; // STATICESKAJA PEREMENNAJA
    static int result;    // rerultat
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            char ch = scanner.next().charAt(0); // BERIOM PERVYJ SIMVOL
            if (ch == 'y') {

                System.out.println("Imput 1st number ar 0 for exit");
                num1 = scanner.nextInt();
                System.out.println("Imput 2num number");
                num2 = scanner.nextInt();
                System.out.println("Imput action ");
